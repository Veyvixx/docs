...
HELP_CATEGORIES = [
    ...
    ("Moderation", "mod", "error", [
        ...
        ("/mod history <user>",     "Combined warnings + ban/kick/timeout history"),
    ]),
    ("AutoMod", "automod", "warning", [
        ("/automod enable <preset>",        "Enable a preset (keyword/spam/invite/link/caps/mention_spam)"),
        ("/automod disable <preset>",       "Disable a preset (call again to delete)"),
        ("/automod list",                   "Show every preset and its state"),
        ("/automod keyword add/remove",     "Manage the custom keyword list"),
        ("/automod keyword list/clear",     "View or wipe the keyword list"),
        ("/automod mentions <limit>",       "Set the mention-spam limit"),
        ("/automod action set",             "Configure timeout / log channel"),
        ("/automod whitelist add_role",     "Exempt a role from a preset"),
        ("/automod whitelist remove_role",  "Stop exempting a role"),
        ("/automod whitelist add_channel",  "Exempt a channel from a preset"),
        ("/automod whitelist remove_channel","Stop exempting a channel"),
    ]),
    ("Giveaways", "gw", "accent", [
        ("/gw start",                  "Start a giveaway (rich options + templates)"),
        ("/gw end <message_id>",       "End early & roll winners"),
        ("/gw reroll <message_id>",    "Pick new winners on a finished giveaway"),
        ("/gw cancel <message_id>",    "Cancel without picking winners"),
        ("/gw list",                   "List active giveaways"),
        ("/gw pause/resume",           "Freeze or resume the countdown"),
        ("/gw edit",                   "Edit prize/winners/duration/image"),
        ("/gw template save",          "Save an option preset ✨"),
        ("/gw template load",          "View a saved template"),
        ("/gw template list",          "List saved templates"),
        ("/gw template delete",        "Remove a saved template"),
    ]),
